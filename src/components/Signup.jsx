            ...
            md:max-w-[616px] md:w-[80%]
             ">
                ...
                ">Create Account</h2>
                    ...
                    <button className="hover:bg-[#D9D9D9] hover:text-[#331517] border border-[#331517] max-w-45 w-full bg-[#331517] font-neuton-light text-[#D9D9D9] rounded-md mt-4 text-base py-2
